...
SECRET_KEY = 'django-insecure-0^6-sj7s_bc68v(0=1t=z&k(plrp2f#=58%f^ejj3l8b$nh+sl'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-mail@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'your-password'  # Your email password

# To handle the contact email (change this to your desired admin email)
CONTACT_EMAIL = 'your-mail@gmail.com'  # Admin email where you want to receive messages
